...
import { primaryPink, primaryPurple, white } from '../assets/colors';
...
import JobPost from '../screens/main/jobpost/JobPost';
import ServiceDetails from '../screens/common/ServiceDetails';
    ...
    return(
        <Tab.Navigator
            ...
            screenOptions={{
                ...
                tabBarActiveTintColor: primaryPurple,
        ...
        >
            ...
            <Tab.Screen 
                options={{
                    tabBarIcon: ({ focused }) => (
                        <>
                            <Icon color={focused ? primaryPurple : white} size={focused ? 28 : 25} name={'md-chatbubbles'}/>
                        </>
                    ),  
            ...
            <Tab.Screen 
                options={{
                    tabBarIcon: ({ focused }) => (
                        <>
                            <Icon color={focused ? primaryPurple : white} size={focused ? 28 : 25} name={'settings'}/>
                        </>
                    ),  
