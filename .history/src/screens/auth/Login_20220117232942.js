...
import { black, fbBlue, gray, outlineGray, primary, primaryPurple } from '../../assets/colors';
    ...
    return(
        <Container style={{justifyContent: 'center', alignItems: 'center', padding: hp('3.5%')}}>
            ...
            <Button
                ...
                style={{borderRadius: 0, marginTop: hp('4%')}}
                textColor={black}
            />
            <View style={{width: '100%', flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center',marginVertical: hp('0%')}}>
                <View style={styles.line}/>
                <Text style={[styles.text,{width: 'auto'}]}>OR</Text>
                <View style={styles.line}/>
            </View>
            <Button
