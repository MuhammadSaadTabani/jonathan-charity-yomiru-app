...
const PackageCard = ({amount, amountType}) => {
    ...
    return(
        ...
        >
            ...
            <TouchableOpacity style={{backgroundColor: white, width: wp('27.5%'), height: hp('4.5%'), borderRadius: hp('1.25%'), justifyContent: 'center', alignItems:'center', alignSelf: 'center'}}>
